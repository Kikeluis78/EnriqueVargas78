    ...
    <main className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white px-4 py-16 flex flex-col items-center overflow-x-hidden">
      <div className="w-full max-w-5xl p-8 bg-gray-800/70 backdrop-blur-lg rounded-3xl shadow-2xl">
        ...
        <div className="flex justify-center gap-6 mb-12" data-aos="fade-down">
          ...
          <Link to="/Precios2">
            <button className="px-6 py-2 rounded-xl font-bold text-sm transition shadow-md
              bg-gray-700 text-white hover:bg-gradient-to-r hover:from-purple-400 hover:via-pink-500 hover:to-yellow-400 hover:text-black">
              🚀 Planes Avanzados
            </button>
          </Link>
        </div>
        ...
        {/* Título */}
        <h1
          className="text-3xl md:text-5xl font-extrabold text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 via-pink-400 to-purple-400 drop-shadow-lg"
          data-aos="fade-down"
        >
          ¡Página WEB Básica!
        </h1>
        ...
        {/* Plan */}
        <h2
          className="text-2xl font-bold text-yellow-300 mb-4 text-center drop-shadow-md"
          data-aos="fade-up"
        >
          Super precio
        </h2>
        ...
        {/* Precio */}
        <p className="flex justify-center items-baseline mb-6 text-center">
        ...
        {/* Notas adicionales */}
        <p className="text-center text-gray-400 text-sm mb-10" data-aos="fade-up">
          Incluye configuración inicial y entrega en{" "}
          <span className="text-yellow-300 font-semibold">máximo 7 días hábiles</span>.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 cursor-pointer">
          {servicios.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="flex items-center gap-4 p-5 bg-gray-900/70 rounded-xl shadow-md hover:scale-105 transition-transform cursor-default"
                data-aos="fade-up"
        ...
        <div className="flex justify-center mt-12">
          <Link to="/Contacto">
            <button
              id="boton-contratar"
              translate="no"
              className="px-6 py-3 bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 text-black font-bold rounded-xl shadow-lg hover:scale-105 transition-transform cursor-pointer whitespace-nowrap"
            >
        ...
        {mostrarBotonScroll && (
          <div className="flex justify-center mt-8">
            <Link to="/Precios2">
              <button className="px-6 py-3 bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 text-black font-bold rounded-xl shadow-lg hover:scale-105 transition-transform animate-bounce cursor-pointer">
                <span className="block">Ver más</span>
                <span className="block">Precios y Paquetes</span>
              </button>
            </Link>
          </div>
        )}
